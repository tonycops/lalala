<nav class="navbar navbar-light navbar-expand-md sticky-top" style="font-family:Lato, sans-serif;background-color:#64bea8;height:55px;margin-bottom:0px;">
    <div class="container-fluid"><a class="navbar-brand" href="<?php echo site_url(); ?>/Route/home" target="_parent" data-bs-hover-animate="pulse"><img src="<?php echo base_url()?>/assets/img/logo_kura.png"></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div
            ...
            <ul class="nav navbar-nav mx-auto">
                ...
                <li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo site_url(); ?>/Route/product">Article</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo site_url(); ?>/Route/product">Story</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo site_url(); ?>/Route/product">Contact Us</a></li>
            ...
            <?php if($this->session->userdata('loggedUser')) : ?>
              <span class="navbar-text" style="margin-right:10px;">
                <a href="<?php echo site_url(); ?>/Route/shopping_cart">Shopping Cart&nbsp;<i class="fa fa-shopping-cart" style="background-size:contain;background-repeat:no-repeat;"></i></a></span>
                <span class="navbar-text">
