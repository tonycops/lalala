...
<?php $this->load->view("template/navbar_product"); ?>
    <div id="wrapper">
        ...
        <div class="page-content-wrapper" style="font-family:Lato, sans-serif;">
            ...
            <form action="<?php echo site_url()?>/Cont_trans/search/product" method="post">    
            ...
            <button class="btn btn-light search-btn" type="submit"> <i class="fa fa-search"></i></button>
                ...
                <div class="row" style="font-family:Lato, sans-serif;">
                    <div class="col-md-12">
                        <div>
                            <h1 style="font-family:Lato, sans-serif;">Torto/Turtle</h1>
                        </div>
                        <?php if(!empty($search)) : ?>
                        <p style="font-family:Lato, sans-serif;">Anda mencari : ' <?php echo $search?> '</p>
                        <?php else :?>
                        <p style="font-family:Lato, sans-serif;">Semua mengenai kura - kura blablabla</p>
                        <?php endif ?>
                    </div>
            </div>
        </div>
        <div class="row product-list" style="font-family:Lato, sans-serif;min-height:50vh;margin-left:0px;">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 d-flex product-item" style="font-family:Lato, sans-serif;min-width:33.3333%;">
                ...
                <form action="<?php echo site_url() ?>/Cont_trans/addToCart/product" method="POST">    
                    <div class="row">
                        <div class="col-md-12"><a href="#" class="product-image"><img src="<?php echo base_url()?>assets/img/<?php echo $items['gambar']?>"></a></div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <h2><a href="#" style="white-space:wrap;font-family:Lato, sans-serif;font-weight:bold;"><?php echo $items['nama']?></a></h2>
                        </div>
                        <div class="col-3" style="padding:0px;">
                            <p class="float-right" style="padding-right:0px;font-family:Lato, sans-serif;">Qty :&nbsp;</p>
                        </div>
                        <div class="col-3" style="padding-left:0px;"><input type="number" name="qty" value="1" placeholder="1" min="1" style="width:100%;margin-top:3px;font-family:Lato, sans-serif;"></div>
                    </div>
                    <div class="row">
                        <div class="col">
                        ...
                        <!-- <div class="col d-flex justify-content-end"><button class="btn btn-primary btn-sm" type="button">Update</button></div> -->
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <p class="product-description" style="white-space:nowrap;text-overflow:ellipsis;overflow:hidden;font-family:Lato, sans-serif;"><?php echo $items['deskripsi']?></p>
                            <div class="row">
                                <?php if($items['stok']) :?>
...
function showResult(str) {
  ...
  xmlhttp.open("GET","<?php echo site_url()?>/Cont_trans/ajaxSearch/product/"+str,true);
  xmlhttp.send();
}
</script>
</html>
