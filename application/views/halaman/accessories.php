...
<body style="font-family:Lato, sans-serif;padding:0px">
    ...
    <div id="wrapper">
        ...
        <div class="page-content-wrapper" style="font-family:Lato, sans-serif;">
            ...
            <form action="<?php echo site_url()?>/Cont_trans/search/accessories" method="post">    
            ...
            <button class="btn btn-light search-btn" type="submit"> <i class="fa fa-search"></i></button>
                ...
                <div
                    ...
                    <div class="col-md-12">
                        <div>
                            <h1 style="font-family:Lato, sans-serif;">Accessories</h1>
                        </div>
                        <?php if(!empty($search)) : ?>
                        <p style="font-family:Lato, sans-serif;">Anda mencari : ' <?php echo $search?> '</p>
                        <?php else :?>
                        <p style="font-family:Lato, sans-serif;">Semua mengenai accessories kura - kura blablabla</p>
                        <?php endif ?>
                    </div>
            </div>
        </div>
        <div class="row product-list" style="font-family:Lato, sans-serif;min-height:50vh;margin-left:0px;">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 d-flex product-item" style="font-family:Lato, sans-serif;min-width:33.3333%;">
                <div class="product-container" style="min-width:100%;">
                    <form action="<?php echo site_url() ?>/Cont_trans/addToCart/accessories" method="POST">   
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="row">
                                    ...
                                    <?php endif ?>
                                <div class="col-6"><label class="col-form-label float-right" style="font-size:20px;font-family:Lato, sans-serif;"><strong>Rp. <?php echo $items['harga']?>,-</strong><br></label></div>
                            </div>
...
function showResult(str) {
  ...
  xmlhttp.open("GET","<?php echo site_url()?>/Cont_trans/ajaxSearch/accessories/"+str,true);
  xmlhttp.send();
}
</script>
</html>